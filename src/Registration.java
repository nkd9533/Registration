	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		StuBean b=new StuBean();
		 ...
		 try {
			...
			ps.setString(2,b.getStuName());
			ps.setString(3,b.getfName());
			ps.setString(4,b.getCollName());
			ps.setDouble(5,b.getHindi());
			ps.setDouble(6,b.getEng());
			ps.setDouble(7,b.getMaths());
			ps.setDouble(8,b.getScience());
			ps.setDouble(9,b.getSst());
			ps.setDouble(10,b.getTotal());
			ps.setDouble(11,b.getPercentage());
			ps.setString(12,b.getDivision());
			...
			if(!rs.next())
			{
				...
				if(i!=0)
				{
				...
				else
				 {
					 ...
					 out.println("Unable to Register, Try again!");
				 }
			}
			else
			 {
				 ...
				 rd.include(request,response);
				 out.println("<h3 style=color:red;>");
				 out.println("Roll Number already exist, You can Update it.");
			 }
		} catch (Exception e) {
